<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\auth\public/../application/admin\view\main\fonticon.html";i:1621919478;s:47:"D:\auth\application\admin\view\public\base.html";i:1621919983;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
$(function(){
	$.ajax({
		url: "<?php echo url('@Admin/File/getIcons'); ?>", //获取后端请求数据地址
		type: 'get',
		async: true,
		dataType: 'json',
