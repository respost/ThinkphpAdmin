<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\auth\public/../application/admin\view\product\type_add.html";i:1621920957;s:47:"D:\auth\application\admin\view\public\base.html";i:1621920483;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="page-head">
	<div id="page-title">
		<h1 class="page-header text-overflow">添加分类</h1>
	</div>
</div>
<div id="page-content">
		...
		<div class="layui-card-body">
			<form class="layui-form" action="<?php echo $config['current_url']; ?>" method="post">
				<div class="layui-form-item">
					...
					<div class="col-md-7">
						<input type="text" name="name" autocomplete="off" required  lay-verify="required" placeholder="请输入分类名称" class="layui-input">
					</div>					
				</div>
				<div class="layui-form-item">
					<label class="col-md-2" style="text-align:right;">排序：</label>
					<div class="col-md-7">
						<input type="text" name="sort" value="0" autocomplete="off" placeholder="请输入排序号" class="layui-input">
					</div>
